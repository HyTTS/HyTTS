 ...
 * and also allows access to some additional metadata.
 */
...
export type FrameMetadata = {
    /**
     * The frame's selector, i.e., either `"body"` or a frame's id, which is required to be unique within
...
/**
 * Creates a new `Frame` instance with the given id. This function is typically invoked in a top-level
 * declaration of a module so that the frame can be used in a type-safe way within the defining module
 * itself but also across modules via exports/imports.
