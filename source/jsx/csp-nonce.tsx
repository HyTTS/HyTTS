...
/**
 * If you use a CSP nonce that forbids inline scripts (as you should for security reasons), you
 * must make the nonce available to HyTTS so that it can work correctly. To do that, place this
 * component into your document's head.
 * Making the nonce available to HyTTS is OK because JS is generally allowed to access it, see
